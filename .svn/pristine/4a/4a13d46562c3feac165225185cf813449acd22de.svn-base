...
public class CloneWithJobApplicantsTest {
  ...
  @Test
  public void cloneWithJobapplicants() throws InvalidFormatException, IOException, InterruptedException
  {   
	  logger.testStepLog("Step 1: get test data from excel");
	  String jobID1= eLib.getExcelData("Jobs", "TC_05", "JobId1");
	  ...
	  logger.testStepLog("Step 3: clone the job with job applicants");
	  jobPage.cloneWithJobApplicant();
	  
	  logger.testStepLog("Step 3: clone the job with job applicants succefully done");
